...
class AIBacktestingEngine:
    ...
    def __init__(self, config: BacktestConfig = None):
        ...
        self.logger.logger.info("🤖 AI Backtesting Engine initialized")

    def run_ai_backtest(self, data_provider) -> Dict:
        """Run comprehensive AI backtest"""
        try:
            self.logger.logger.info("🚀 Starting AI Backtest")
            self.logger.logger.info(f"Symbols: {', '.join(self.config.symbols)}")
            self.logger.logger.info(f"Period: {self.config.start_date} to {self.config.end_date}")
            self.logger.logger.info(f"Initial Capital: ₹{self.config.initial_capital:,.0f}")
            ...
            for symbol in self.config.symbols:
                try:
                    ...
                    if not df.empty:
                        ...
                        self.logger.logger.warning(f"No data for {symbol}")
            ...
            self.logger.logger.info("✅ AI Backtest completed successfully!")
            return report

        except Exception as e:
            self.logger.logger.error(f"Error in AI backtest: {e}")
            return {'error': str(e)}
    ...
    def _walk_forward_backtest(self, all_data: Dict, portfolio: UnifiedPortfolio) -> Dict:
        ...
        try:
            ...
            while current_date_idx < len(trading_days):
                ...
                if retrain_needed:
                    self.logger.logger.info(f"🔄 Retraining models for date: {current_date}")
                ...
                for symbol, df in all_data.items():
                    try:
                        ...
                        self.logger.logger.error(f"Error getting predictions for {symbol}: {e}")
            ...
            self.logger.logger.error(f"Error in walk-forward backtest: {e}")
            return {'error': str(e)}
        ...
        try:
            ...
            for symbol, prediction in predictions.items():
                try:
                    ...
                    self.logger.logger.error(f"Error executing AI trade for {symbol}: {e}")

            return trades

        except Exception as e:
            self.logger.logger.error(f"Error executing AI trades: {e}")
            return []
    ...
    def _calculate_position_size(self, symbol: str, price: float,
        ...
        try:
            ...
            self.logger.logger.error(f"Error calculating position size for {symbol}: {e}")
            return 0.0
    ...
    def _generate_backtest_report(self, results: Dict, portfolio: UnifiedPortfolio) -> Dict:
        ...
        try:
            ...
            self.logger.logger.error(f"Error generating backtest report: {e}")
            return {'error': str(e)}
    ...
    def _calculate_max_drawdown(self, portfolio_values: List[float]) -> float:
        ...
        try:
            ...
            self.logger.logger.error(f"Error calculating max drawdown: {e}")
            return 0.0
    ...
    def _save_backtest_results(self, report: Dict):
        ...
        try:
            ...
            self.logger.logger.info(f"✅ Backtest results saved to {self.config.results_dir}")

        except Exception as e:
            self.logger.logger.error(f"Error saving backtest results: {e}")
    ...
    def _generate_performance_plots(self, report: Dict):
        ...
        try:
            ...
            self.logger.logger.info(f"✅ Performance plots saved to {plot_file}")

        except Exception as e:
            self.logger.logger.error(f"Error generating performance plots: {e}")
        ...
        try:
            ...
            for params in param_combinations:
                ...
                try:
                    ...
                    self.logger.logger.error(f"Error testing parameters {param_dict}: {e}")
                    continue
            ...
            self.logger.logger.error(f"Error in grid search optimization: {e}")
            return {'error': str(e)}
