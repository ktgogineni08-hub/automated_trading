...
class TradingLauncher:
    def __init__(self):
        ...
        self.dashboard_url = getattr(TradingConfig.from_env(), "dashboard_url", "https://localhost:8080")
    ...
    def launch_dashboard(self):
        ...
        try:
            ...
            try:
                ...
                print(f"✅ Dashboard started at: {self.dashboard_url}")
                print(f"   (Please open {self.dashboard_url} in your browser)")
        ...
        try:
            ...
            if choice == "1":
                ...
                if launcher.launch_dashboard():
                    ...
                    print(f"📊 Open {launcher.dashboard_url} in your browser")
                ...
                if launcher.launch_dashboard():
                    ...
                    if launcher.launch_trading_system():
                        ...
                        print(f"📊 Dashboard: {launcher.dashboard_url}")
                ...
                print(f"3. Open {launcher.dashboard_url} in your browser")
