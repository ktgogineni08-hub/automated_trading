...
class ConfigurationValidator:
    ...
    def _validate_environment_variables(self):
        ...
        required_matrix = {
            'DASHBOARD_API_KEY': {
                'description': 'Dashboard authentication key',
                'required_modes': {'paper', 'live'},
            },
            'ZERODHA_API_KEY': {
        ...
        mode = (self.trading_mode or 'paper').lower()

        for var, spec in required_matrix.items():
            ...
            if not value:
                ...
                self.results.append(ValidationResult(
                    ...
                    name=var,
                    message=f'Missing {"required" if required else "recommended"} environment variable: {var} ({description})',
                    severity=severity
                ))
                continue
